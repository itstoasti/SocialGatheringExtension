...
import { Link, Skeleton, Stack, Text, Box, VStack } from '@chakra-ui/react'
...
const Links = () => {
  return (
    <Stack data-testid="information-links" maxW="none">
      <ExternalLink
...
const About = ({ clientRepo }: AboutProps) => {
  return (
    <Box width="100%" maxW="none">
      <VStack spacing={10} align="stretch" width="100%" maxW="none">
