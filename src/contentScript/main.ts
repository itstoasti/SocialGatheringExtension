...
import './posting/TwitterComposeAutomation'
import './posting/TikTokUploadAutomation'
import './posting/ThreadsComposeAutomation'
import './posting/FacebookPostAutomation'
import { isBetaTweetDeck, isTwitter, isTikTok, isTikTokStudioUpload } from './utils/checker'
import { runtime } from 'webextension-polyfill'

// Debug log to verify content script is loading
console.log('🚀 Content script loaded on:', window.location.href)
console.log('🔍 Is TikTok page:', isTikTok())
console.log('🔍 Is TikTok Studio upload:', isTikTokStudioUpload())
...
runtime.onMessage.addListener((message, _sender, sendResponse) => {
  ...
  if (isErrorResult(messageResult)) return false
